...
export default function UserInfo() {
  ...
  return (
    ...
    <div className='flex flex-col justify-center items-center'>
        ...
        <input type="text" id="examname" name="examname" className='border-2 border-blue-800 w-3/4 max-w-xl text-center p-2' placeholder="e.g. Half Yearly Exam" required/>
        <label for="class" className='text-xl text-center select-none leading-normal p-2'>Class Number: </label>
        <input type="text" id="class" name="class" className='border-2 border-blue-800 w-3/4 max-w-xl text-center p-2' placeholder="e.g. Class 2" required/>
        <label for="subject" className='text-xl text-center select-none leading-normal p-2'>Subject: </label>
        <input type="text" id="subject" name="subject" className='border-2 border-blue-800 w-3/4 max-w-xl text-center p-2' placeholder="Enter Subject Name..." required/>
        <div className='w-3/4 max-w-xl text-center mt-8 mb-8 flex justify-between'>
        <button className='bg-blue-500 hover:bg-blue-800 text-white font-bold py-2 px-4 rounded-full h-full' onClick={handleForm}>
                Proceed
        </button>
        <div className='mt-2'>
